    ...
    auto self = shared_from_this();
     ...
     if (id == "Start") {
        ...
        currentScene = createScene<DialogueScene>(self, vector<DialogueLine>{
            ...
            {"", "", "assets/images/Pharmacy_desk.jpg", "none", "assets/sounds/sound-effects-footsteps.mp3", "assets/sounds/yearning-for-trees.ogg", false},
        ...
        currentScene = createScene<DialogueScene>(self, vector<DialogueLine>{
            ...
            {"Pharmacist", "Now... the medicine... I will be back shortly...", "assets/images/Pharmacy_desk.jpg", "assets/images/doorun_sprite.png", "none", "assets/sounds/yearning-for-trees.ogg"},
            {"", "", "assets/images/Pharmacy_desk.jpg", "none", "assets/sounds/sound-effects-footsteps.mp3", "assets/sounds/yearning-for-trees.ogg", false},
            {"Pharmacist", "Here... is the prescription.", "assets/images/Pharmacy_desk.jpg", "assets/images/doorun_sprite.png", "none", "assets/sounds/yearning-for-trees.ogg"},
